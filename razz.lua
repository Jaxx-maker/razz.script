...
function Horizon:CreateWindow(config)
    ...
    HomeTab:AddParagraph({
        ...
        Content = "Made by seabas • Discord: discord.gg/nARYPm8K45"
    })
    ...
    task.spawn(function()
        ...
        Window:Notify({
            Title = "Horizon UI Library",
            Content = "This UI is powered by Horizon. For updates, support, and documentation join our server: https://discord.gg/nARYPm8K45",
            Duration = 8
        })
        ...
        Window:Notify({
            Title = "UI Controls",
            Content = "Press Right Control to show/hide the UI",
            Duration = 5
        })
    end)
